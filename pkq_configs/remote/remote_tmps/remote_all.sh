...
echo "condaenv path "
sbatch --signal=B:USR1@120 --time=1-00:00:00 --nodes=1 --output=pkqlogs/20260919_100649/job-%j.out --error=pkqlogs/20260919_100649/job-%j.out  --gpus=1 --cpus-per-task=8 --mem=30G  -A naiss2026-3-658-gpu  --partition=gpu pkq_configs/remote/remote_tmps/slurm.sh
