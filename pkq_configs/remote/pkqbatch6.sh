...
PKQ_RUN_COMMAND="python experiments/run_layerwise_finetune.py \
...
#   --trained_checkpoint_path ${PKQ_DATA_DIR}/output/layerwise/Meta-Llama-3.1-8B-msmarco-mntp-L0/checkpoint-3929 \
#   --query_top_k 40 \
#   --doc_top_k 400 \
#   --output_dir results \
#   --max_length 1024 \
