...
export JWM_RUN_COMMAND="python experiments/reranker.py ${JWM_DATA_DIR}/msmarco_hard_negatives_v2.json --output ${JWM_DATA_DIR}/reranked_hard_negatives_v2.json --queries-per-batch 4"
