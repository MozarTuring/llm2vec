...
#   --config output/layerwise/Meta-Llama-3.1-8B-msmarco-mntp-L26/MetaLlama3.1-mntp-layerwise.json \
#   --trained_checkpoint_path output/layerwise/Meta-Llama-3.1-8B-msmarco-mntp-L26/checkpoint-3929 \
#   --query_top_k 40 \
#   --doc_top_k 400 \
#   --output_dir results \
